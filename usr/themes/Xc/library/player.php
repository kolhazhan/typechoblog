...
<body>
<div id="dplayer"></div>
  <script src="https://cdn.staticfile.org/hls.js/1.4.13/hls.min.js"></script>
  <script src="https://cdn.staticfile.org/dplayer/1.27.1/DPlayer.min.js"></script>
  <script>
    new DPlayer({
      ...
      video: {
        url: '<?php echo addslashes(strip_tags($_GET['url'])); ?>',
      }
    })
  </script>
</body>
