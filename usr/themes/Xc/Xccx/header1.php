...
<link rel="stylesheet" href="<?php _getAssets('assets/Xc/css/Xc.dhltm.css'); ?>" />
<?php endif; ?>
...
<a class="item <?php echo $this->is('index') ? 'active' : '' ?>" href="<?php $this->options->siteUrl(); ?>" title="首页" style="margin-right:8px"><i class="iconfont icon-shouye"></i> 首页</a>
...
<a class="nofollow <?php echo $this->is('category', $category->slug) ? 'active' : '' ?>" href="<?php $category->permalink(); ?>"><i class="iconfont icon-<?php $category->slug(); ?>"></i> <?php $category->name(); ?></a>
