...
<script src="<?php _getAssets('assets/Xc/js/Xc.index1.min.js'); ?>"></script>
...
?>
<?php if ($index_notice) : ?>
<div class="Xc_home_column-notice">
<svg class="icon2" aria-hidden="true"><use xlink:href="#icon-A13"></use></svg>
