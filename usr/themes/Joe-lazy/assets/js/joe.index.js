document.addEventListener("DOMContentLoaded", () => {
  /* 激活轮播图功能 */
  {
    if ($(".joe_index__banner .swiper-container").length !== 0) {
      ...
      if (
        !/windows phone|iphone|android/gi.test(window.navigator.userAgent) &&
    ...
    const getListMode = (_) => {
      if (_.mode === "default") {
        return `
          ...
          _.title
        }" target="${_.target}" rel="noopener noreferrer">
          ...
          _.target
        }" rel="noopener noreferrer">${_.abstract}</a>
                            <div class="meta">
                                <ul class="items">
                                    <li><i class="ri-time-line"></i>&nbsp;${
                                      _.created
                                    }</li>
                                    <li><i class="ri-eye-line"></i>&nbsp;${
                                      _.views
                                    }</li>
                                    <li><i class="ri-message-3-line"></i>&nbsp;${
                                      _.commentsNum
                                    }</li>
                                    <li><i class="ri-thumb-up-line"></i>&nbsp;${
                                      _.agree
                                    }</li>
                                </ul>
        ...
        return `
          ...
          _.title
                        ...
                        <div class="meta">
                            ...
                            <li><i class="ri-eye-line"></i>&nbsp;${_.views}</li>
                            <li><i class="ri-message-3-line"></i>&nbsp;${
                              _.commentsNum
                            }</li>
                            <li><i class="ri-thumb-up-line"></i>&nbsp;${
    ...
    const pushDom = () => {
      return new Promise((reslove, reject) => {
        ...
        $.ajax({
          ...
          beforeSend() {
            $(".joe_index__title-title .item").css({
              "pointer-events": "none",
              cursor: "not-allowed",
            });
          },
