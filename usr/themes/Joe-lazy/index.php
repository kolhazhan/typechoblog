 ...
 * @package Joe懒人版
 * @author Joe、易航、浅梦
 * @link https://letanml.xyz/web-build/21.html
 * 二开人：易航、浅梦
 */
?>
...
<head>
	...
	<link rel="stylesheet" href="<?= joe\theme_url('assets/lib/swiper/swiper-bundle.min.css'); ?>">
	<script src="<?= joe\theme_url('assets/lib/swiper/swiper-bundle.min.js'); ?>"></script>
	<script src="<?= joe\theme_url('assets/lib/wowjs/wow.min.js'); ?>"></script>
